...
(function ($) {
	...
	var touchSlider = {
		...
		touchstart : function (e) {
			if( e.type == "touchstart" && e.originalEvent.touches.length <= 1 && this._touch) {
		...
		touchmove : function (e) {
			if( e.type == "touchmove" && e.originalEvent.touches.length <= 1 && this._type == "slide" && this._touch) {
		...
		touchend : function (e) {
			if(e.type == "touchend" && e.originalEvent.touches.length <= 1 && this._touch) {
				if(this._scroll) {
					this._drag = false;
					this._scroll = false;
					return false;
